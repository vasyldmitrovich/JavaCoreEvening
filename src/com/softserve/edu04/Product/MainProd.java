...
public class MainProd {
    public static void main(String[] args){
        ...
        Prod Something2 = new Prod(7, 6.5, 12);
        Prod Something3 = new Prod( 55, 1.3, 45);
       ...
       {System.out.println("Найдородчий продукт:" + Something1.getName() + "Кількість: " + Something1.getQuantity());
        ...
        else   if (Something2.getPrice() > Something3.getPrice() && Something2.getPrice() > Something4.getPrice() && Something2.getPrice() > Something1.getPrice());
            {System.out.println("Найдородчий продукт:" + Something2.getName() + "Кількість: " + Something2.getQuantity());
            }
        else  if (Something3.getPrice() > Something4.getPrice() && Something3.getPrice() > Something1.getPrice() && Something3.getPrice() > Something2.getPrice());
            {System.out.println("Найдородчий продукт:" + Something3.getName() + "Кількість: " + Something3.getQuantity());
            }
        else  if (Something4.getPrice() > Something1.getPrice() && Something4.getPrice() > Something2.getPrice() && Something4.getPrice() > Something3.getPrice());
        ...
        else if (Something2.getQuantity() > Something1.getQuantity() && Something2.getQuantity() > Something3.getQuantity() && Something2.getQuantity() > Something4.getQuantity());
             {System.out.println("Найбільше на залишку: " + Something2.getName() + "Кількість: " + Something2.getQuantity());
             }
        else if (Something3.getQuantity() > Something2.getQuantity() && Something3.getQuantity() > Something1.getQuantity() && Something3.getQuantity() > Something4.getQuantity());
            {System.out.println("Найбільше на залишку: " + Something3.getName() + "Кількість: " + Something3.getQuantity());
            }
        else if(Something4.getQuantity() > Something1.getQuantity() && Something4.getQuantity() > Something2.getQuantity() && Something4.getQuantity() > Something3.getQuantity());
